...
def send_verification_email(email):
    ...
    message = Mail(
        ...
        html_content=f'Thank you for registering for our Gong Cha membership.<br>If this was not done by you, please ignore this email.<br><br>Please click this to <a href="{verification_link}">verify</a> your account.<br><br>Best Regards,<br> FashionHub Accounts Department<br><img src="https://thumbs.dreamstime.com/z/sustainable-fashion-logo-eco-friendly-production-label-icon-badge-clothes-hanger-green-leaves-natural-recycling-215122758.jpg" width="120" height="120"></img>'
    )
    try:
...
def UserRegistrationPage():
    ...
    if request.method == "POST" and create_user_form.validate():
        ...
        user = Customer.User(create_user_form.userName.data, create_user_form.userPassword.data,
    ...
    return render_template('/User/account/CustomerRegistration.html', form=create_user_form)
