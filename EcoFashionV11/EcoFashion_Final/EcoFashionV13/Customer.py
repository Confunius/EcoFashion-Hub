...
class User:
    count_id = 0
    def __init__(self,userName,userPassword,userEmail, userCfmPassword, userAddress, userPostalCode, userVerified=0): # initializer method    def __init__(self, userName, userPassword, userEmail, userCfmEmail):
        User.count_id += 1
