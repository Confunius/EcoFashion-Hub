class Admin:
    count_id = 0
    def __init__(self,adminFirstName,adminLastName,adminUserName,adminPassword,adminEmail, adminCfmPassword, adminPhoneNumber): # initializer method    def __init__(self, userName, userPassword, userEmail, userCfmEmail):
        Admin.count_id += 1
